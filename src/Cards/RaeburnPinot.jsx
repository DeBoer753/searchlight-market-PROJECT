...
// CSS
import styles from '../Cards/RaeburnPinot.module.css'; // Make sure to create a CSS file (e.g., FlipCard.css) for styling
                ...
                <div className={styles.flipCardInner}>
                    ...
                    <div className={styles.flipCardFront}>
                        <div className={styles.innerElement}>
                            ...
                            <img src={process.env.PUBLIC_URL + '/imgs/skus/raeburn_pinot.png'} alt="" />
                            
                            <div className={styles.cardBottomHalf}>
                                <h5 className={styles.ofAge}>• Must be 21 years or older to purchase •</h5>
                                <h3>Raeburn Pinot Noir</h3>
                                <p className={styles.description}>Description</p>
                                <p className={styles.skuDescription}>This exceptional wine has consistently garnered acclaim, earning prestigious awards year after year for its outstanding quality and craftsmanship. Its remarkable consistency and flavorful profile have made it a favorite among wine enthusiasts and critics alike.</p>
                                <div className={styles.miniBoxContainer}>
                                    <div className={styles.miniBox1}>
                                        <h4>Pairing</h4> 
                                        <hr />
                                        <h5 className={styles.pairing}>Thyme chicken<br />Mushroom tart<br />Berry brie salad</h5>
                                    </div>
                                    <div className={styles.miniBox2}>
                                        <h4>Origin</h4>
                                        <hr />
                                        <h5 className={styles.origin}>Sonoma County, CA</h5>
                                    </div>
