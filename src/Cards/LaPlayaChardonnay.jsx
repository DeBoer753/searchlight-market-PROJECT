...
// CSS
import styles from '../Cards/LaPlayaChardonnay.module.css'; // Make sure to create a CSS file (e.g., FlipCard.css) for styling
                ...
                <div className={styles.flipCardInner}>
                    ...
                    <div className={styles.flipCardFront}>
                        <div className={styles.innerElement}>
                            ...
                            <img className={styles.bottle} src={process.env.PUBLIC_URL + '/imgs/skus/laplaya_chardonnay.png'} alt="" />
                            
                            <div className={styles.cardBottomHalf}>
                                <h5 className={styles.ofAge}>• Must be 21 years or older to purchase •</h5>
                                <h3>La Playa Estate Series Chardonnay</h3>
                                <p className={styles.description}>Description</p>
                                <p className={styles.skuDescription}>A bang for your buck, and your health! This chardonnay is a versatile and enjoyable white wine that is suitable for casual gatherings to more formal dinners. La Playa wines are produced with a focus on responsible viticulture and environmental stewardship.</p>
                                <div className={styles.miniBoxContainer}>
                                    ...
                                    <div className={styles.miniBox3}>
                                        <h4>Taste</h4>
                                        <hr />
                                        <h5 className={styles.taste}>Bold<br />Sweet / Dry<br />Soft</h5>
                                    </div>
                                </div>
                            </div>
                        </div>  
