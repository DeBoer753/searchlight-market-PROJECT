                ...
                <div className={styles.flipCardInner}>
                    ...
                    <div className={styles.flipCardFront}>
                        <div className={styles.innerElement}>
                            ...
                            <img className={styles.bottle} src={process.env.PUBLIC_URL + '/imgs/skus/cannonball_blanc.png'} alt="" />
                            ...
                            <div className={styles.cardBottomHalf}>
                                ...
                                <p className={styles.skuDescription}>_______</p>
                                <div className={styles.miniBoxContainer}>
                                    <div className={styles.miniBox1}>
                                        <h4>Pairing</h4> 
                                        <hr />
                                        <h5 className={styles.pairing}>_______<br />_______<br />_______</h5>
                                    </div>
                                    <div className={styles.miniBox2}>
                                        <h4>Origin</h4>
                                        <hr />
                                        <h5 className={styles.origin}>_______</h5>
                                    </div>
                                    <div className={styles.miniBox3}>
                                        <h4>Taste</h4>
                                        <hr />
                                        <h5 className={styles.taste}>_______<br />_______<br />_______</h5>
                                    </div>
                                </div>
                            </div>
                        </div>  
