...
// CSS
import styles from '../Cards/DeliriumTremens.module.css'; // Make sure to create a CSS file (e.g., FlipCard.css) for styling

// CARD
const DeliriumTremens = () => {
                ...
                <div className={styles.flipCardInner}>
                    ...
                    <div className={styles.flipCardFront}>
                        <div className={styles.innerElement}>
                            ...
                            <img src={process.env.PUBLIC_URL + '/imgs/skus/delirium_tremens.png'} alt="" />
                            ...
                            <div className={styles.cardBottomHalf}>
                                ...
                                <p className={styles.skuDescription}>Delirium Tremens is a world-renowned Belgian ale that stands out for its exceptional taste and quality. With its iconic pink elephant branding and high alcohol content, Delirium Tremens is a top choice for those who appreciate bold, well-crafted Belgian ales.</p>
                                <div className={styles.miniBoxContainer}> 
                                    <div className={styles.miniBox1}>
                                        <h4>Pairing</h4> 
                                        <hr />
                                        <h5 className={styles.pairing}>Grilled shrimp<br />Steak<br />Dark chocolate</h5>
                                    </div>
                                    ...
                                    <div className={styles.miniBox3}>
                                        <h4>Taste</h4>
                                        <hr />
                                        <h5 className={styles.taste}>Smooth / Rich<br />Subtle bitter<br />Subtle sweet</h5>
                                    </div>
                                </div>
                            </div>
                        </div>  
...
export default DeliriumTremens;