...
// CSS
import styles from '../Cards/DomaineDrouhinPinot.module.css'; // Make sure to create a CSS file (e.g., FlipCard.css) for styling

// CARD
const DomaineDrouhinPinot = () => {
                ...
                <div className={styles.flipCardInner}>
                    ...
                    <div className={styles.flipCardFront}>
                        <div className={styles.innerElement}>
                            ...
                            <img src={process.env.PUBLIC_URL + '/imgs/skus/domaine_drouhin_pinot.png'} alt="" />
                            
                            <div className={styles.cardBottomHalf}>
                                <h5 className={styles.ofAge}>• Must be 21 years or older to purchase •</h5>
                                <h3>Domaine Drouhin Pinot Noir</h3>
                                <p className={styles.description}>Description</p>
                                <p className={styles.skuDescription}>Experience the unparalleled craftsmanship of Domaine Drouhin Pinot Noir from Dundee Hills, Oregon. From hand sorting to de-stemming before being aged in custom French oak barrels made in Burgundy, this process ensures a wine of unmatched quality.</p>
                                <div className={styles.miniBoxContainer}> 
                                    <div className={styles.miniBox1}>
                                        <h4>Pairing</h4> 
                                        <hr />
                                        <h5 className={styles.pairing}>Swordfish<br />Eggplant Parmesan<br />Pasta Primavera</h5>
                                    </div>
                                    <div className={styles.miniBox2}>
                                        <h4>Origin</h4>
                                        <hr />
                                        <h5 className={styles.origin}>Willamette Valley, OR</h5>
                                    </div>
                                    <div className={styles.miniBox3}>
                                        <h4>Taste</h4>
                                        <hr />
                                        <h5 className={styles.taste}>Light<br />Smooth<br />Dry</h5>
                                    </div>
                                </div>
                            </div>
                        </div>  
...
export default DomaineDrouhinPinot;