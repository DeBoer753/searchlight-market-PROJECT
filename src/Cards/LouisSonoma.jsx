...
// CSS
import styles from '../Cards/LouisSonoma.module.css'; // Make sure to create a CSS file (e.g., FlipCard.css) for styling
                ...
                <div className={styles.flipCardInner}>
                    ...
                    <div className={styles.flipCardFront}>
                        <div className={styles.innerElement}>
                            ...
                            <img src={process.env.PUBLIC_URL + '/imgs/skus/louis_sonoma.png'} alt="" />
                            
                            <div className={styles.cardBottomHalf}>
                                <h5 className={styles.ofAge}>• Must be 21 years or older to purchase •</h5>
                                <h3>Louis M. Martini Sonoma Cabernet</h3>
                                <p className={styles.description}>Description</p>
                                <p className={styles.skuDescription}>Enjoy a glass of Louis M. Martini Sonoma Cabernet during the calm evening hours. The wine's dark berry and subtle spice notes are at their best as the day winds down. Whether shared or enjoyed solo, it's a simple thrill to savor.</p>
                                <div className={styles.miniBoxContainer}> 
                                    <div className={styles.miniBox1}>
                                        <h4>Pairing</h4> 
                                        <hr />
                                        <h5 className={styles.pairing}>Pasta bolognese<br />Caprese salad<br />Dark chocolate</h5>
                                    </div>
                                    <div className={styles.miniBox2}>
                                        <h4>Origin</h4>
                                        <hr />
                                        <h5 className={styles.origin}>Napa Valley, CA</h5>
                                    </div>
                                    <div className={styles.miniBox3}>
                                        <h4>Taste</h4>
                                        <hr />
                                        <h5 className={styles.taste}>Bold<br />Tannic<br />Soft</h5>
                                    </div>
                                </div>
                            </div>
                        </div>  
