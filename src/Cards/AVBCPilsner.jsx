...
// CSS
import styles from '../Cards/AVBCPilsner.module.css'; // Make sure to create a CSS file (e.g., FlipCard.css) for styling
                ...
                <div className={styles.flipCardInner}>
                    ...
                    <div className={styles.flipCardFront}>
                        <div className={styles.innerElement}>
                            ...
                            <img src={process.env.PUBLIC_URL + '/imgs/skus/avbc_pilsner.png'} alt="" />
                            
                            <div className={styles.cardBottomHalf}>
                                <h5 className={styles.ofAge}>• Must be 21 years or older to purchase •</h5>
                                <h3>Anderson Valley The Pilsner</h3>
                                <p className={styles.description}>Description</p>
                                <p className={styles.skuDescription}>A labor of love and passion it could have no other name than THE PILSNER, and it is the mother of all beer-flavored-beers The Pilsner is soft, crisp, clean, and delicious and while extremely drinkable it is also flavorful and complex.</p>
                                <div className={styles.miniBoxContainer}> 
                                    <div className={styles.miniBox1}>
                                        <h4>Pairing</h4> 
                                        <hr />
                                        <h5 className={styles.pairing}>Crab<br />Beef Kway<br />Grilled chicken</h5>
                                    </div>
                                    ...
                                    <div className={styles.miniBox3}>
                                        <h4>Taste</h4>
                                        <hr />
                                        <h5 className={styles.taste}>Crisp<br />Malt<br />Subtle sweet</h5>
                                    </div>
                                </div>
                            </div>
                        </div>  
