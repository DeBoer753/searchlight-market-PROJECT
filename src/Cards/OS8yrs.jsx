...
// CSS
import styles from '../Cards/OS8yrs.module.css'; // Make sure to create a CSS file (e.g., FlipCard.css) for styling
                ...
                <div className={styles.flipCardInner}>
                    ...
                    <div className={styles.flipCardFront}>
                        <div className={styles.innerElement}>
                            ...
                            <img src={process.env.PUBLIC_URL + '/imgs/skus/os_8yrs.png'} alt="" />
                            
                            <div className={styles.cardBottomHalf}>
                                <h5 className={styles.ofAge}>• Must be 21 years or older to purchase •</h5>
                                <h3>Orin Swift 8yrs in the Desert 2023</h3>
                                <p className={styles.description}>Description</p>
                                <p className={styles.skuDescription}>The wine is a blend of Zinfandel, Syrah, Petite Sirah, and other premium varietals. It's described as bold, complex, and versatile, and pairs well with a variety of foods.</p>
                                <div className={styles.miniBoxContainer}>
                                    <div className={styles.miniBox1}>
                                        <h4>Pairing</h4> 
                                        <hr />
                                        <h5 className={styles.pairing}>Grilled pork<br />Roasted mushrooms<br />Gouda cheese</h5>
                                    </div>
                                    ...
                                    <div className={styles.miniBox3}>
                                        <h4>Taste</h4>
                                        <hr />
                                        <h5 className={styles.taste}>Bold<br />Dry<br />Smooth</h5>
                                    </div> 
                                </div>
                            </div>
                        </div>  
