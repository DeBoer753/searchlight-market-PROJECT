// BACKSIDE DATA
export const storeName = "SEARCHLIGHT MARKET"
export const description1 = "Hello, and welcome to Searchlight Market! My name is Myles and I am a full time beverage sales rep / web developer hobbyist who created the card you are seeing now."
...
// export const message = '"It is that time of year again 🍁 Cheers to another cozy Fall season!"'
export const message = '"Let Fleet Week commence! Grab some drinks and find high ground or head to the Marina to see them close and up front! ✈️💨"'
