...
// CSS
import styles from '../Cards/GlutenbergPaleAle.module.css'; // Make sure to create a CSS file (e.g., FlipCard.css) for styling

// CARD
const GlutenbergPaleAle = () => {
...
export default GlutenbergPaleAle;