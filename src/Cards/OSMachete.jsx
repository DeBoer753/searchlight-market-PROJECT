...
// CSS
import styles from '../Cards/OSMachete.module.css'; // Make sure to create a CSS file (e.g., FlipCard.css) for styling
                ...
                <div className={styles.flipCardInner}>
                    ...
                    <div className={styles.flipCardFront}>
                        <div className={styles.innerElement}>
                            ...
                            <img src={process.env.PUBLIC_URL + '/imgs/skus/os_machete.png'} alt="" />
                            
                            <div className={styles.cardBottomHalf}>
                                <h5 className={styles.ofAge}>• Must be 21 years or older to purchase •</h5>
                                <h3>Orin Swift Machete</h3>
                                <p className={styles.description}>Description</p>
                                <p className={styles.skuDescription}>Orin Swift Machete is an opulent red blend that captivates with its bold, edgy character. Enjoy this high-end wine with your favorite hearty dishes or on its own for a truly indulgent evening. Orin Swift is also known for their incredible wines as collector items.</p>
                                <div className={styles.miniBoxContainer}>
                                    <div className={styles.miniBox1}>
                                        <h4>Pairing</h4> 
                                        <hr />
                                        <h5 className={styles.pairing}>Steak<br />Stuffed mushrooms<br />Grilled steak salad</h5>
                                    </div>
                                    ...
                                    <div className={styles.miniBox3}>
                                        <h4>Taste</h4>
                                        <hr />
                                        <h5 className={styles.taste}>Bold<br />Tannic<br />Dry / Acidic</h5>
                                    </div>
                                </div>
                            </div>
                        </div>  
