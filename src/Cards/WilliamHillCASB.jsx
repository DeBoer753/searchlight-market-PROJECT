...
// CSS
import styles from '../Cards/WilliamHillCASB.module.css'; // Make sure to create a CSS file (e.g., FlipCard.css) for styling

// CARD
const WilliamHillCASB = () => {
                ...
                <div className={styles.flipCardInner}>
                    ...
                    <div className={styles.flipCardFront}>
                        <div className={styles.innerElement}>
                            ...
                            <img src={process.env.PUBLIC_URL + '/imgs/skus/william_hill_ca_sb.png'} alt="" />
                            
                            <div className={styles.cardBottomHalf}>
                                <h5 className={styles.ofAge}>• Must be 21 years or older to purchase •</h5>
                                <h3>William Hill Sauvignon Blanc</h3>
                                <p className={styles.description}>Description</p>
                                <p className={styles.skuDescription}>Offering aromas of citrus and honeysuckle. This wine has a round mouthfeel that leads to a refreshingly crisp and lively finish. From exceptional vineyards come exceptional wines, and this William Hill Sauvignon Blanc celebrates the famed wine-growing region of California.</p>
                                <div className={styles.miniBoxContainer}>
                                    <div className={styles.miniBox1}>
                                        <h4>Pairing</h4> 
                                        <hr />
                                        <h5 className={styles.pairing}>Crab<br />Asparagus<br />Green salad</h5>
                                    </div>
                                    <div className={styles.miniBox2}>
                                        <h4>Origin</h4>
                                        <hr />
                                        <h5 className={styles.origin}>Napa, CA</h5>
                                    </div>
...
export default WilliamHillCASB;