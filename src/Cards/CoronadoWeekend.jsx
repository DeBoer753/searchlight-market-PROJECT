...
// CSS
import styles from '../Cards/CoronadoWeekend.module.css'; // Make sure to create a CSS file (e.g., FlipCard.css) for styling

// CARD
const CoronadoWeekend = () => {
                ...
                <div className={styles.flipCardInner}>
                    ...
                    <div className={styles.flipCardFront}>
                        <div className={styles.innerElement}>
                            ...
                            <img src={process.env.PUBLIC_URL + '/imgs/skus/coronado_weekend.png'} alt="" />
                            
                            <div className={styles.cardBottomHalf}>
                                <h5 className={styles.ofAge}>• Must be 21 years or older to purchase •</h5>
                                <h3>Coronado Weekend Vibes IPA</h3>
                                <p className={styles.description}>Description</p>
                                <p className={styles.skuDescription}>This easy-drinking IPA is perfect for lazy weekends spent with friends or unwinding after a long day. Let its smooth, balanced bitterness and crisp finish transport you to a state of relaxation and good vibes, no matter the day of the week. </p>
                                <div className={styles.miniBoxContainer}> 
                                    <div className={styles.miniBox1}>
                                        <h4>Pairing</h4> 
                                        <hr />
                                        <h5 className={styles.pairing}>Cajun shrimp<br />Tacos<br />Buffalo strips</h5>
                                    </div>
                                    ...
                                    <div className={styles.miniBox3}>
                                        <h4>Taste</h4>
                                        <hr />
                                        <h5 className={styles.taste}>Bright<br />Hop Fruity <br />Dry</h5>
                                    </div>
                                </div>
                            </div>
                        </div>  
...
export default CoronadoWeekend;