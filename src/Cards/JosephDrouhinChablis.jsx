...
// CSS
import styles from '../Cards/JosephDrouhinChablis.module.css'; // Make sure to create a CSS file (e.g., FlipCard.css) for styling
                ...
                <div className={styles.flipCardInner}>
                    ...
                    <div className={styles.flipCardFront}>
                        <div className={styles.innerElement}>
                            ...
                            <img src={process.env.PUBLIC_URL + '/imgs/skus/joseph_drouhin_chablis.png'} alt="" />
                            
                            <div className={styles.cardBottomHalf}>
                                <h5 className={styles.ofAge}>• Must be 21 years or older to purchase •</h5>
                                <h3>Joseph Drouhin Vaudon Chablis</h3>
                                <p className={styles.description}>Description</p>
                                <p className={styles.skuDescription}>The Kimmeridgian limestone contains millions of tiny marine fossils embedded in a kind of whitish mortar which may have been once the bottom of the sea...hundreds of million years ago. This marine origin gives the Vaudon Chablis its unique flavour.</p>
