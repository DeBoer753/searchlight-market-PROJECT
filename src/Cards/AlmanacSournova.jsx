...
// CSS
import styles from '../Cards/AlmanacSournova.module.css'; // Make sure to create a CSS file (e.g., FlipCard.css) for styling

// CARD
const AlmanacSournova = () => {
                ...
                <div className={styles.flipCardInner}>
                    ...
                    <div className={styles.flipCardFront}>
                        <div className={styles.innerElement}>
                            ...
                            <img src={process.env.PUBLIC_URL + '/imgs/skus/almanac_sournova.png'} alt="" />
                            
                            <div className={styles.cardBottomHalf}>
                                <h5 className={styles.ofAge}>• Must be 21 years or older to purchase •</h5>
                                <h3>Almanac Barrel Aged Strawberry Sournova</h3>
                                <p className={styles.description}>Description</p>
                                <p className={styles.skuDescription}>The Strawberry Sournova is aged in oak barrels with strawberries and vanilla beans. Savor the taste of pure delight with this sparkling refresher. Revel in each kaleidoscopic sip, and raise a toast to the good life! </p>
                                <div className={styles.miniBoxContainer}> 
                                    <div className={styles.miniBox1}>
                                        <h4>Pairing</h4> 
                                        <hr />
                                        <h5 className={styles.pairing}>Pork<br />Goat cheese<br />Citrus salad</h5>
                                    </div>
                                    ...
                                    <div className={styles.miniBox3}>
                                        <h4>Taste</h4>
                                        <hr />
                                        <h5 className={styles.taste}>Fruity<br />Tart<br />Sour</h5>
                                    </div>
                                </div>
                            </div>
                        </div>  
...
export default AlmanacSournova;