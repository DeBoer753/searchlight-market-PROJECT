...
// CSS
import styles from '../Cards/AlmanacKolsch.module.css'; // Make sure to create a CSS file (e.g., FlipCard.css) for styling
                ...
                <div className={styles.flipCardInner}>
                    ...
                    <div className={styles.flipCardFront}>
                        <div className={styles.innerElement}>
                            ...
                            <img src={process.env.PUBLIC_URL + '/imgs/skus/almanac_kolsch.png'} alt="" />
                            
                            <div className={styles.cardBottomHalf}>
                                <h5 className={styles.ofAge}>• Must be 21 years or older to purchase •</h5>
                                <h3>Almanac True Kolsch</h3>
                                <p className={styles.description}>Description</p>
                                <p className={styles.skuDescription}>It’s TRUE, this German Kölsch-style ale is a crisp, light and unfussy beer that makes enjoying food and friends just a little more wunderbar. Prost!</p>
                                <div className={styles.miniBoxContainer}> 
                                    <div className={styles.miniBox1}>
                                        <h4>Pairing</h4> 
                                        <hr />
                                        <h5 className={styles.pairing}>Buffalo wings<br />Pizza<br />Charcuterie</h5>
                                    </div>
                                    ...
                                    <div className={styles.miniBox3}>
                                        <h4>Taste</h4>
                                        <hr />
                                        <h5 className={styles.taste}>Crisp<br />Light<br />Smooth</h5>
                                    </div>
                                </div>
                            </div>
                        </div>  
