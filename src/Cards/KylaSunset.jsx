...
// CSS
import styles from '../Cards/KylaSunset.module.css'; // Make sure to create a CSS file (e.g., FlipCard.css) for styling
                ...
                <div className={styles.flipCardInner}>
                    ...
                    <div className={styles.flipCardFront}>
                        <div className={styles.innerElement}>
                            ...
                            <img src={process.env.PUBLIC_URL + '/imgs/skus/kyla_sunset.png'} alt="" />
                            
                            <div className={styles.cardBottomHalf}>
                                <h5 className={styles.ofAge}>• Must be 21 years or older to purchase •</h5>
                                <h3>Kyla Kombucha Sunset Trio</h3>
                                <p className={styles.description}>Description</p>
                                <p className={styles.skuDescription}>Kyla Kombucha, a Gold Medal Winner at the 2021 U.S. Open Hard Kombucha Championship. With three tantalizing flavors to choose from, including passion fruit, orange, and guava, each sip is a journey to paradise.</p>
                                <div className={styles.miniBoxContainer}> 
                                    <div className={styles.miniBox1}>
                                        <h4>Pairing</h4> 
                                        <hr />
                                        <h5 className={styles.pairing}>Thai curry<br />Falafel fruit salad<br />Pulled pork</h5>
                                    </div>
                                    ...
                                    <div className={styles.miniBox3}>
                                        <h4>Taste</h4>
                                        <hr />
                                        <h5 className={styles.taste}>Passion fruit<br />Orange<br />Guava</h5>
                                    </div>
                                </div>
                            </div>
                        </div>  
